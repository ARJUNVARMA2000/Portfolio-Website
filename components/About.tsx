      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h2 className="font-cyber text-3xl md:text-4xl font-bold text-white mb-4">
            <span className="text-cyber-cyan">&lt;</span> About Me{" "}
        ...
        <motion.h3
          ...
          viewport={{ once: true }}
          className="font-cyber text-2xl text-center mb-8 text-white"
        >
          <FaGraduationCap className="inline-block mr-3 text-cyber-cyan" />
          Education
        </motion.h3>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-cyber text-xl text-cyber-cyan group-hover:text-glow-cyan transition-all">
                    {edu.school}
                  </h4>
                  <p className="text-gray-400 flex items-center gap-2 mt-1">
                    <FaMapMarkerAlt className="text-cyber-magenta" size={12} />
                    {edu.location}
                  </p>
                  <p className="text-white font-medium mt-2">{edu.degree}</p>
                  <p className="text-cyber-yellow text-sm mt-1">{edu.period}</p>
                  <ul className="mt-3 space-y-1">
                    {edu.highlights.map((highlight) => (
                      ...
                      >
                        <FaMedal className="text-cyber-cyan mt-1 flex-shrink-0" size={12} />
                        {highlight}
                      </li>
                    ))}
                  </ul>
